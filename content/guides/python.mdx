...
author: Dante
date: 2025-09-14
thumbnail: https://images.unsplash.com/photo-1624953587687-daf255b6b80a?q=80&w=1374&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D
---

This guide shows you how to install Python 3.13 on [Mac](#mac), [Windows](#windows), and/or [Linux](#linux).
...
Now that Python 3.13 is installed, you're ready to [install aegis](../../docs/getting-started/installation).

## Windows

You can install Python on Windows using the official installer from [python.org](https://www.python.org/downloads/release/python-3137/)
...
Go to [python.org](https://www.python.org/downloads/release/python-3137/) and scroll down to the Files section.
...
<Callout title="Windows PATH" type="warning">
...
<Callout title="Install Command" type="warning">
